...
- 2026-04-22 executor error sidecar draft는 `docs/reports/V1_5_REINDEX_LIVE_ADAPTER_EXECUTOR_ERROR_SIDECAR_DRAFT_2026-04-22.md`를 기준으로 guarded executor failure를 `mutation_executor_error` sidecar와 promotion router failure route evidence로 노출한다. 다음 단계는 post-error-sidecar enablement checkpoint review다.
