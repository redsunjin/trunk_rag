...
- 2026-04-22 guarded live executor smoke command draft는 `docs/reports/V1_5_REINDEX_LIVE_ADAPTER_GUARDED_LIVE_EXECUTOR_SMOKE_COMMAND_DRAFT_2026-04-22.md`를 기준으로 `--opt-in-live-binding-stage-guarded` command surface와 guarded runtime sidecar summary를 고정했다. 다음 단계는 guarded live executor smoke evidence draft다.
