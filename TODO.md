...
| --- | --- | --- | --- |
| LOOP-001 | active | 배포형 웹 MVP 게이트 | `./.venv/bin/python -m pytest -q` + `./.venv/bin/python scripts/check_ops_baseline_gate.py --llm-provider lmstudio --llm-model qwen3.5-4b-mlx-4bit --llm-base-url http://127.0.0.1:1337/v1` |
