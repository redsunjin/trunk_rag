...
- current_active_id: `LOOP-073`
- current_active_title: `V1.5 reindex live adapter guarded top-level promotion gate draft`
...
### A-Next66. V1.5 reindex live adapter guarded top-level promotion gate draft (현재 active)
