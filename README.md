...
- 다음 우선순위: V1 회귀 게이트를 유지하면서 V1.5 `reindex` live adapter pre-side-effect executor router implementation draft를 진행하고, live scope는 여전히 `reindex` 단일 tool 후보로만 다룬다
